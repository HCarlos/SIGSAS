...
<div class="sticky-nav">
    ...
    <ul class="nav nav-tabs-scroll is-scrollable nav-tabs nav-tabs-simple p-1px pl-25 bgc-secondary-l4 border-b-1 brc-dark-l3 radius-t-1" role="tablist">
        <li class="nav-item mr-2 mr-lg-3">
            <a href="#Profile1" class="d-style nav-link active px-2 py-35 brc-primary-tp1" data-toggle="tab" aria-expanded="false" role="tab" aria-controls="profile-tab-overview" >
                <span class="d-n-active text-dark-l1">Perfil</span>
                <span class="d-active text-dark-m3">Perfil</span>
            </a>
        </li>

        <li class="nav-item mr-2 mr-lg-3">
            <a href="#Domicilio1" class="d-style nav-link px-2 py-35 brc-primary-tp1" data-toggle="tab" aria-expanded="false" role="tab" aria-controls="profile-tab-overview">
                <span class="d-n-active text-dark-l1">Domicilio</span>
                <span class="d-active text-dark-m3">Domicilio</span>
            </a>
        </li>

        <li class="nav-item mr-2 mr-lg-3">
            <a href="#Ocupaciion1" class="d-style nav-link px-2 py-35 brc-primary-tp1" data-toggle="tab" aria-expanded="false" role="tab" aria-controls="profile-tab-overview">
                <span class="d-n-active text-dark-l1">Ocupación</span>
                <span class="d-active text-dark-m3">Ocupación</span>
            </a>
        </li>
...
{{--                        <a href="{{route("newUbicacion")}}" target="_blank" class="btn btn-icon btn-info"> <i class="mdi mdi-plus"></i></a>--}}
                        <a href="#" target="_blank" class="btn btn-icon btn-info"> <i class="mdi mdi-plus"></i></a>
                    </span>
                </div>
