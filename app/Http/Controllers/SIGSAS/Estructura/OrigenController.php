...
use App\Http\Requests\SIGSAS\Denuncia\OrigenRequest;
...
// ***************** MUESTRA EL LISTADO DE USUARIOS ++++++++++++++++++++ //
    protected function index(Request $request)
    {
        ...
        return view('SIGSAS.Estructura.origen.origen_list',
            [
                'items' => $items,
    ...
    {
        return view('SIGSAS.Estructura.origen.origen_new',
            [
                'editItemTitle'   => 'Nuevo',
    ...
    protected function newItemV2()
    {
        ...
        return view('SIGSAS._comun.__modal_comun_1',
            [
                ...
                'Method'      => 'POST',
                'items_forms' => 'SIGSAS.Estructura.origen.__origen.__origen_new',
                'IsNew'       => true,
                'user'        => $user,
