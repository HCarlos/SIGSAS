...
use App\Http\Requests\SIGSAS\Denuncia\AfiliacionRequest;
...
// ***************** MUESTRA EL LISTADO DE USUARIOS ++++++++++++++++++++ //
    protected function index(Request $request)
    {
        ...
        return view('SIGSAS.Estructura.afiliacion.afiliacion_list',
            [
                'items'           => $items,
...
// ***************** EDITA LOS DATOS  ++++++++++++++++++++ //
    protected function editItem($Id)
    {
        ...
        return view('SIGSAS.Estructura.afiliacion.afiliacion_edit',
            [
                'user' => Auth::user(),
                'items' => $item,
...
// ***************** GUARDA LOS CAMBIOS ++++++++++++++++++++ //
    ...
    {
        return view('SIGSAS.Estructura.afiliacion.afiliacion_new',
            [
                'editItemTitle'   => 'Nuevo',
