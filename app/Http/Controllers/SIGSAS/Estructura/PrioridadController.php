...
use App\Http\Requests\SIGSAS\Denuncia\PrioridadRequest;
...
// ***************** MUESTRA EL LISTADO DE USUARIOS ++++++++++++++++++++ //
    protected function index(Request $request)
    {
        ...
        return view('SIGSAS.Estructura.prioridad.prioridad_list',
            [
                'items'           => $items,
    ...
    {
        return view('SIGSAS.Estructura.prioridad.prioridad_new',
            [
                'editItemTitle'   => 'Nuevo',
    ...
    protected function newItemV2()
    {
        ...
        return view('SIGSAS._comun.__modal_comun_1',
            [
                ...
                'Method'      => 'POST',
                'items_forms' => 'SIGSAS.Estructura.prioridad.__prioridad.__prioridad_new',
                'IsNew'       => true,
                'user'        => $user,
...
// ***************** EDITA LOS DATOS  ++++++++++++++++++++ //
    protected function editItem($Id)
    {
        ...
        return view('SIGSAS.Estructura.prioridad.prioridad_edit',
            [
                'user'            => Auth::user(),
                'items'           => $item,
    ...
    protected function editItemV2($Id)
    {
        ...
        return view('SIGSAS._comun.__modal_comun_1',
            [
                ...
                'Method'      => 'POST',
                'items'       => $item,
                'items_forms' => 'SIGSAS.Estructura.prioridad.__prioridad.__prioridad_edit',
                'IsNew'       => false,
                'IsModal'     => true,
                'user'        => $user,
