...
use App\Http\Requests\SIGSAS\Denuncia\MedidaRequest;
...
// ***************** MUESTRA EL LISTADO DE USUARIOS ++++++++++++++++++++ //
    protected function index(Request $request)
    {
        ...
        return view('SIGSAS.Estructura.medida.medida_list',
            [
                'items'           => $items,
    ...
    {
        return view('SIGSAS.Estructura.medida.medida_new',
            [
                'editItemTitle'   => 'Nuevo',
    ...
    protected function newItemV2()
    {
        ...
        return view('SIGSAS._comun.__modal_comun_1',
            [
                ...
                'Method'      => 'POST',
                'items_forms' => 'SIGSAS.Estructura.medida.__medida.__medida_new',
                'IsNew'       => true,
                'user'        => $user,
...
// ***************** EDITA LOS DATOS  ++++++++++++++++++++ //
    ...
    {
        $item = Medida::find($Id);
        return view('SIGSAS.Estructura.medida.medida_edit',
            [
                'user'            => Auth::user(),
                'items'           => $item,
