...
use App\Http\Requests\SIGSAS\Denuncia\StatuRequest;
...
// ***************** MUESTRA EL LISTADO DE USUARIOS ++++++++++++++++++++ //
    protected function index(Request $request)
    {
        ...
        return view('SIGSAS.Estructura.estatu.estatu_list',
            [
                'items'           => $items,
    ...
    protected function newItem()
    {
        $Dependencias = Dependencia::select('id','dependencia')
            ->orderBy('dependencia')
            ->get();
        return view('SIGSAS.Estructura.estatu.estatu_modal',
            [
    ...
    protected function newItemV2()
    {
        ...
        return view('SIGSAS.Estructura.estatu.estatu_modal',
            [
                ...
                'Method'          => 'POST',
                'items_forms'     => 'SIGSAS.Estructura.estatu.__estatu.__estatu_new',
                'IsNew'           => true,
                'user'            => $user,
                'dependencia'     => $Dependencias,
            ]
...
// ***************** EDITA LOS DATOS  ++++++++++++++++++++ //
    protected function editItem($Id)
    {
        $Dependencias = Dependencia::select('id','dependencia')
            ...
            ->get();
        $item = Estatu::find($Id);
        return view('SIGSAS.Estructura.estatu.estatu_edit',
            [
                'user' => Auth::user(),
                'items' => $item,
    ...
    protected function editItemV2($Id)
    {
        ...
        return view('SIGSAS.Estructura.estatu.estatu_modal',
            [
                ...
                'Method'          => 'POST',
                'items_forms'     => 'SIGSAS.Estructura.estatu.__estatu.__estatu_edit',
                'IsNew'           => false,
                'IsModal'         => true,
                'IsModalEdit'     => true,
                'items'           => $item,
