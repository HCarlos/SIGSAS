...
namespace App\Http\Controllers\SIGSAS\Denuncia\Imagene;

use App\Classes\FuncionesController;
use App\Classes\GeneralFunctions;
use App\Classes\MessageAlertClass;
use App\Http\Controllers\Controller;
use App\Http\Requests\SIGSAS\Denuncia\Imagene\ImagenAImagenRequest;
use App\Http\Requests\SIGSAS\Denuncia\Imagene\ImageneRequest;
...
//***************************************************************+++++++++++++++++++**
    ...
    protected function index($Id)
    {
        ...
        return view('SIGSAS.Denuncia.Images.imagene_list',
            [
                'items'                 => $items,
...
// ***************** ELIMINA LOS REGISTROS SELECCIONADOS VIA AJAX ++++++++++++++++++++ //
    ...
    protected function showModalImageneNew($denuncia_id){
        $user = Auth::user();
        return view ('SIGSAS.Denuncia.Images.imagene_upload',
            [
    ...
    protected function showModalImageneEdit($Id){
        ...
        return view ('SIGSAS.Denuncia.Images.imagene_edit_data',
            [
                'Route'       => 'saveImageneDen',
                'Method'      => 'POST',
                'items_forms' => 'SIGSAS.Denuncia.Images.__images.__imagene_edit_data',
                'IsNew'       => false,
                'item'        => $item,
                'user'        => $user,
                'removeItem'  => 'removeImagene',
...
// IMAGEN A IMAGEN
    ...
    protected function ImagenAImagenNew($denuncia_id,$imagen_id){
        $user = Auth::user();
        return view ('SIGSAS.Denuncia.Imagen_A_Imagen.imagen_a_imagen_upload',
            [
